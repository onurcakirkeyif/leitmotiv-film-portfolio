  ...
  return (
    <div style={{ minHeight: "100vh" }}>
      ...
      <div className="px-8 pt-8 pb-12 border-b" style={{ borderColor: "rgba(0,0,0,0.08)" }}>
        ...
        <p className="text-[11px] font-bold tracking-[0.25em] max-w-2xl leading-relaxed text-justify" style={{ color: "rgba(0,0,0,0.5)" }}>{service.intro}</p>
      </div>
        ...
        <div className="md:col-span-2 p-12 border-r" style={{ borderColor: "rgba(0,0,0,0.08)" }}>
          {service.body.split("\n\n").map((para, i) => (
            <motion.p
              ...
              className="leading-relaxed mb-6 text-[11px] font-bold tracking-[0.25em] text-justify"
          ...
          <div className="space-y-4">
            {service.highlights.map((h, i) => (
              ...
              >
                ...
                <span className="text-[11px] font-bold tracking-[0.25em]" style={{ color: "rgba(0,0,0,0.6)" }}>{h}</span>
              </motion.div>
            ))}
          </div>
