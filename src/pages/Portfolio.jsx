...
const projects = [
  ...
  },
  {
    ...
    client: "Endemol Shine / Nine Network",
    thumbnail: "https://i.ytimg.com/vi/OMzsNGfR13Y/maxresdefault.jpg",
    url: "https://www.youtube.com/watch?v=OMzsNGfR13Y",
  },
  {
    title: "Raiders of the Lost Past – World's Oldest City",
    client: "BBC",
    thumbnail: "https://i.ytimg.com/vi/CHkIiQ7ghyw/hqdefault.jpg",
    url: "https://www.youtube.com/watch?v=CHkIiQ7ghyw",
  },
  {
    title: "Iznik: The Ottoman Art That Captivated Europe",
    client: "BBC Reel",
    thumbnail: "https://ichef.bbci.co.uk/images/ic/320x180/p0m75r6v.jpg",
    url: "https://www.bbc.com/reel/video/p0m75qxp/iznik-the-ottoman-art-that-captivated-europe",
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Selected
            <span className="font-serif italic text-amber-500"> Projects</span>
          </h1>
