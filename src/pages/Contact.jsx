...
const contactInfo = [
  {
    icon: Phone,
    label: "Phone",
    value: "+90 555 354 75 85",
    href: "tel:+905553547585",
  },
  {
    icon: Mail,
    label: "Email",
    value: "info@leitmotivfilm.net",
    href: "mailto:info@leitmotivfilm.net",
  },
  {
    icon: MessageCircle,
    label: "WhatsApp",
    value: "+90 555 354 75 85",
    href: "https://wa.me/905553547585",
  },
  {
    icon: Instagram,
    label: "Instagram",
    value: "@leitmotiv_film",
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Let's Work
            <span className="font-serif italic text-amber-500"> Together</span>
          </h1>
          ...
          <div className="lg:col-span-2 space-y-6">
            {contactInfo.map((item, i) => (
              <motion.a
                ...
                className="flex items-start gap-4 p-5 rounded-xl border border-white/5 bg-white/[0.02] hover:border-amber-500/20 hover:bg-white/[0.04] transition-all duration-300 group"
              >
