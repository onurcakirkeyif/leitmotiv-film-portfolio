      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="p-12 border-r" style={{ borderColor: "rgba(0,0,0,0.08)" }}>
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <p className="leading-relaxed mb-12 text-base max-w-sm" style={{ color: "rgba(0,0,0,0.5)" }}>
            ...
            <div className="space-y-8">
              <div>
                ...
                <a href="mailto:info@leitmotivfilm.net" className="text-xl font-bold transition-opacity hover:opacity-50" style={{ color: "#111" }}>
                  info@leitmotivfilm.net
                </a>
              </div>
              <div>
                <p className="text-[10px] uppercase tracking-[0.3em] mb-2" style={{ color: "rgba(0,0,0,0.3)" }}>Phone / WhatsApp</p>
                <a href="tel:+905553547585" className="text-xl font-bold transition-opacity hover:opacity-50" style={{ color: "#111" }}>
                  +90 555 354 75 85
                </a>
              </div>
              <div>
                ...
                <a href="https://instagram.com/leitmotiv_film" target="_blank" rel="noopener noreferrer"
                  className="text-xl font-bold transition-opacity hover:opacity-50" style={{ color: "#111" }}>
                  @leitmotiv_film
                </a>
              </div>
              <div>
